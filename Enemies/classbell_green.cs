...
public class classbell_green : EnemyFSM
{
    ...
    public void AttackMethod()
    {
        ...
        PoolManager.GetInstance().GetObj("Prefab/Bullet/classbell_green_bullet", (o) =>
        {
            //o.transform.position = transform.position + new Vector3(1.81f * transform.localScale.x, 0, 0);
            o.transform.position = transform.position;
            o.GetComponent<classbell_green_bullet>().Init(parameter.attack, new Vector2(transform.localScale.x, 1), bulletSpeed, transform.localScale.x);

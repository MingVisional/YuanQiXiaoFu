...
public class fan_green : EnemyFSM
{
    ...
    public void AttackMethod()
    {
        if (parameter.target != null)
        {
            ...
            PoolManager.GetInstance().GetObj("Prefab/Bullet/fan_bullet", (o) =>
            {
                o.transform.position = transform.position + new Vector3(transform.localScale.x*0.63f,0.17f,0);
                o.GetComponent<fan_bullet>().Init(parameter.attack, new Vector2(0.5f* transform.localScale.x, 0.5f), bulletSpeed, transform.localScale.x);

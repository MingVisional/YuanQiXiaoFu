...
public class tree : EnemyFSM
{
    ...
    public void AttackMethod()
    {
        ...
        PoolManager.GetInstance().GetObj("Prefab/Bullet/tree_bullet", (o) =>
        {
            o.transform.position = transform.position + new Vector3(1.18f * transform.localScale.x, 0.24f, 0);
            o.GetComponent<tree_bullet>().Init(parameter.attack, new Vector2(transform.localScale.x * 1f, 1f), bulletSpeed, transform.localScale.x);

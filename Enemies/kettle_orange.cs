...
public class kettle_orange : EnemyFSM
{
    private static float attackAreaR = 0.9f;//攻击半径
    void Start()
    {
    ...
    public void AttackMethod()
    {
        ...
        //Debug.Log("攻击");
        if (Physics2D.OverlapCircle(transform.position + new Vector3(0.3f * transform.localScale.x, -0.3f, 0), attackAreaR, parameter.targetLayer))
        {
    ...
    {
        Gizmos.DrawWireSphere(transform.position + new Vector3(0.3f * transform.localScale.x, -0.3f, 0), attackAreaR);
    }*/
    ...
    public class ChaseState : StateBase
    {
        ...
        public void OnUpdate()
        {
            ...
            if (parameter.target != null &&
                ...
                Physics2D.OverlapCircle(manager.transform.position + new Vector3(0.3f * manager.transform.localScale.x, -0.3f, 0), attackAreaR, parameter.targetLayer))
            {

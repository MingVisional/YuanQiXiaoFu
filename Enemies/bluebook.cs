...
public class bluebook : EnemyFSM
{
    ...
    public void AttackMethod()
    {
        ...
        PoolManager.GetInstance().GetObj("Prefab/Bullet/bluebook_bullet_" + Random.Range(1, 6).ToString(), (o) =>
        {
            o.transform.position = transform.position + new Vector3(1f * transform.localScale.x, Random.Range(-0.5f, 0.5f), 0);
            o.GetComponent<bluebook_bullet>().Init(parameter.attack, new Vector2(transform.localScale.x, 1), bulletSpeed, transform.localScale.x);
            //o.transform.SetParent(transform.parent.Find("BulletManager"));
    ...
    public class ChaseState : StateBase
    {
        ...
        public void OnUpdate()
        {
            ...
            {
                if (System.Math.Abs(parameter.target.transform.position.y - manager.transform.position.y) < 0.5f)
                {
    ...
    public class DeathState : StateBase
    {
        ...
        /*private float deathTime = 1.0f/60*25;
        ...
        public void OnUpdate()
        {
            //info = parameter.animator.GetCurrentAnimatorStateInfo(0);
            /*timer += Time.deltaTime;
            if (timer >= 0.9f * deathTime) manager.Death();*/
            /*if (info.normalizedTime >= 0.95f)
            {
                manager.Death();
            }*/

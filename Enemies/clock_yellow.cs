...
public class clock_yellow : EnemyFSM
{
    ...
    {
        parameter.attackAudio.Play();
        PoolManager.GetInstance().GetObj("Prefab/Bullet/clock_yellow_bullet", (o) =>
        {
            //o.transform.position = transform.position + new Vector3(1.81f * transform.localScale.x, 0, 0);
            o.transform.position = transform.position;
            o.GetComponent<clock_yellow_bullet>().Init(parameter.attack, new Vector2(transform.localScale.x*0.8f, 0.8f), bulletSpeed, transform.localScale.x);

...
public class redbook : EnemyFSM
{
    ...
    public void AttackMethod()
    {
        ...
        PoolManager.GetInstance().GetObj("Prefab/Bullet/redbook_bullet_" + Random.Range(1, 12).ToString(), (o) =>
        {
            o.transform.position = transform.position + new Vector3(1f * transform.localScale.x, Random.Range(-0.5f, 0.5f), 0);
            o.GetComponent<redbook_bullet>().Init(parameter.attack, new Vector2(transform.localScale.x*4f, 4f), bulletSpeed, transform.localScale.x);

...
public class BOSSRoommate_bullet1 : MonoBehaviour
{
    public float attack;
    private float dir;
    private float speed;
    private Vector2 targetDir;
    new protected string name = "BOSSRoommate_bullet1";
    public void Init(float attack, Vector3 scale, float speed, float dir, Vector2 targetPosition, Sprite sprite)
    {
        this.attack = attack;
